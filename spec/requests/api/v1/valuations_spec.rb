...
RSpec.describe 'API V1 Valuations', type: :request do
  ...
  path '/api/v1/valuations' do
    post 'Create valuation' do
      description 'Create a valuation in an account the authenticated user can write to.'
      tags 'Valuations'
      security [ { apiKeyAuth: [] } ]
  ...
  path '/api/v1/valuations/{id}' do
    ...
    get 'Retrieve a valuation' do
      description 'Retrieve a valuation from an account the authenticated user can access.'
      tags 'Valuations'
      security [ { apiKeyAuth: [] } ]
      produces 'application/json'
    ...
    patch 'Update a valuation' do
      description 'Update a valuation in an account the authenticated user can write to.'
      tags 'Valuations'
      security [ { apiKeyAuth: [] } ]
      consumes 'application/json'
      produces 'application/json'
