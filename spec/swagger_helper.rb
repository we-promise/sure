        ...
        schemas: {
          ...
          TransferDecision: {
            ...
            properties: {
              ...
              notes: { type: :string, nullable: true },
              source_fee_amount: { type: :number, nullable: true, description: 'Fee charged to the source account' },
              source_fee_currency: { type: :string, nullable: true },
              destination_fee_amount: { type: :number, nullable: true, description: 'Fee deducted from the destination account' },
