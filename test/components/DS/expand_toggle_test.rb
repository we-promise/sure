...
class DS::ExpandToggleTest < ViewComponent::TestCase
  test "renders the presence-marker attribute and icon-only shell the sidebar JS keys off" do
    ...
    # Icon-only: the accessible name lives on the button (not a text node), and
    # both state icons are present (the collapse icon is hidden by default and
