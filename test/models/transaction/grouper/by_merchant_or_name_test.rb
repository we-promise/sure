...
class Transaction::Grouper::ByMerchantOrNameTest < ActiveSupport::TestCase
  ...
  test "respects limit and offset" do
    ...
    # limit
    groups = Transaction::Grouper::ByMerchantOrName.call(@family, limit: 2)
    assert_equal 2, groups.size

    # all groups
    all_groups = Transaction::Grouper::ByMerchantOrName.call(@family, limit: 10)
    assert_equal 3, all_groups.size

    # offset skips leading groups
    offset_groups = Transaction::Grouper::ByMerchantOrName.call(@family, limit: 10, offset: 1)
