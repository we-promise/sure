...
class AccountTest < ActiveSupport::TestCase
  ...
  test "allows the same iban across different families" do
    ...
    other_family_account = other_family.accounts.build(name: "Other family account", balance: 0, currency: "USD", accountable: Depository.new, iban: "AT611904300234573201")
