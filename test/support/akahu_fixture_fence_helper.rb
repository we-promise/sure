...
# AkahuItem::LegacyAccessTest uses real commits and does not include this.
module AkahuFixtureFenceHelper
  def run
    ...
    fence.stub(:with_item, fixture_permit) do
      AkahuItem::LegacyAccess.stub(:assert_transport!, nil) do
