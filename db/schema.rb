...
ActiveRecord::Schema[7.2].define(version: 2026_05_31_213000) do
  ...
  create_table "transactions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.jsonb "extra", default: {}, null: false
    t.string "investment_activity_label"
    t.uuid "refund_of_transaction_id"
    ...
    t.index ["refund_of_transaction_id"], name: "index_transactions_on_refund_of_transaction_id"
  end
  ...
  create_table "transfers", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.decimal "source_fee_amount", precision: 19, scale: 4, default: "0.0", null: false
    t.decimal "destination_fee_amount", precision: 19, scale: 4, default: "0.0", null: false
    ...
    t.check_constraint "destination_fee_amount >= 0::numeric", name: "check_destination_fee_non_negative"
    t.check_constraint "source_fee_amount >= 0::numeric", name: "check_source_fee_non_negative"
  end
