...
ActiveRecord::Schema[7.2].define(version: 2026_05_09_130000) do
  ...
  create_table "families", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "dismissed_migration_notices", default: [], null: false, array: true
  ...
  create_table "provider_accounts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
  ...
  create_table "provider_connections", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "family_id", null: false
    t.uuid "provider_family_config_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index "((metadata ->> 'plaid_item_id'::text))", name: "index_provider_connections_on_plaid_item_id", where: "(metadata ? 'plaid_item_id'::text)"
    t.index [ "family_id", "provider_key" ], name: "index_provider_connections_on_family_id_and_provider_key"
    t.index [ "family_id" ], name: "index_provider_connections_on_family_id"
    t.index [ "provider_family_config_id" ], name: "index_provider_connections_on_provider_family_config_id"
  end

  create_table "provider_family_configs", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "family_id", null: false
    t.string "provider_key", null: false
    t.jsonb "credentials", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index [ "family_id", "provider_key" ], name: "index_provider_family_configs_on_family_id_and_provider_key", unique: true
    t.index [ "family_id" ], name: "index_provider_family_configs_on_family_id"
  end
  ...
  create_table "truelayer_accounts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "truelayer_item_id", null: false
    t.string "account_id", null: false
    ...
    t.index [ "truelayer_item_id", "account_id" ], name: "idx_truelayer_accounts_on_item_and_account_id", unique: true
    t.index [ "truelayer_item_id" ], name: "index_truelayer_accounts_on_truelayer_item_id"
  end

  create_table "truelayer_items", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "family_id", null: false
    t.string "name", null: false
  ...
  add_foreign_key "provider_connections", "provider_family_configs"
  add_foreign_key "provider_family_configs", "families"
  ...
  add_foreign_key "truelayer_accounts", "truelayer_items"
  add_foreign_key "truelayer_items", "families"
