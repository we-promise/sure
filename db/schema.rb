...
ActiveRecord::Schema[8.1].define(version: 2026_07_02_000001) do
  ...
  create_table "wise_accounts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["wise_item_id", "wise_account_id"], name: "index_wise_accounts_on_wise_item_id_and_wise_account_id", unique: true
    t.index ["wise_item_id"], name: "index_wise_accounts_on_wise_item_id"
    t.index ["wise_profile_id"], name: "index_wise_accounts_on_wise_profile_id"
  end
