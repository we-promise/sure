...
module Sure
  class Application < Rails::Application
    ...
    MissionControl::Jobs.http_basic_auth_user = "mission_control_jobs"
    MissionControl::Jobs.http_basic_auth_password = ENV["MISSION_CONTROL_JOBS_PASSWORD"] || "mission_control_jobs"
  end
end
