...
Rails.application.config.after_initialize do
  ...
  # Deliberately NOT chained as `elsif` onto the checks above:
  ...
  # is configured/backfilled at all or where its keys come from. Suppressing
  # it whenever AR encryption has explicit keys would hide a real compromise
  # of sessions/Settings just because AR encryption itself isn't affected.
