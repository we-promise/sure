class PlaidItemsController < ApplicationController
  ...
  def select_existing_account
    ...
    if @available_plaid_accounts.empty?
      redirect_to account_path(@account), alert: t("controllers.plaid_items.no_available_accounts")
    end
  end
  ...
  def link_existing_account
    ...
    unless Current.family.plaid_items.include?(plaid_account.plaid_item)
      redirect_to account_path(@account), alert: t("controllers.plaid_items.invalid_account")
      return
    end

    # Verify the Plaid account is not already linked
    if plaid_account.account_provider.present? || plaid_account.account.present?
      redirect_to account_path(@account), alert: t("controllers.plaid_items.already_linked")
      return
    end
    ...
    redirect_to accounts_path, notice: t("controllers.plaid_items.linked")
  end
