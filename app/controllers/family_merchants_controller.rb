class FamilyMerchantsController < ApplicationController
  ...
  def index
    ...
    @pagy_family_merchants, @family_merchants = pagy(@all_family_merchants, limit: safe_per_page)
    @pagy_provider_merchants, @provider_merchants = pagy(@all_provider_merchants, limit: safe_per_page)
