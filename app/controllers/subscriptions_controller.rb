class SubscriptionsController < ApplicationController
  ...
  def upgrade
    if Current.family.subscription&.active?
      redirect_to root_path, notice: t("controllers.subscriptions.already_contributing")
    else
  ...
  def create
    if Current.family.can_start_trial?
      ...
      redirect_to root_path, notice: t("controllers.subscriptions.welcome")
    else
      redirect_to root_path, alert: t("controllers.subscriptions.trial_completed")
    end
  end
  ...
  def success
    ...
    if checkout_result.success?
      ...
      redirect_to root_path, notice: t("controllers.subscriptions.welcome_contribution")
    else
      redirect_to root_path, alert: t("controllers.subscriptions.contribution_failed")
    end
  end
