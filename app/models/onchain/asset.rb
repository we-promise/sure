...
module Onchain
  Asset = Data.define(:kind, :symbol, :name, :decimals, :quantity, :contract) do
    ...
    def self.token(kind:, symbol:, name:, decimals:, quantity:, contract:)
      new(kind: kind, symbol: symbol, name: name, decimals: decimals, quantity: quantity, contract: contract)
    end
