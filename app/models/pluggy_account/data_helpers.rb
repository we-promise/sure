...
module PluggyAccount::DataHelpers
  ...
  private
    ...
    def parse_decimal(value)
      ...
      Rails.logger.error("PluggyAccount::DataHelpers - Failed to parse decimal value: #{value.inspect} - #{e.message}")
      nil
    end
    ...
    def parse_date(date_value)
      ...
      Rails.logger.error("PluggyAccount::DataHelpers - Failed to parse date: #{date_value.inspect} - #{e.message}")
      nil
    end
