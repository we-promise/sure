module Trading212Item::Unlinking
  extend ActiveSupport::Concern

  def unlink_all!(dry_run: false)
    results = []

    trading212_accounts.find_each do |provider_account|
      links = AccountProvider.where(provider_type: "Trading212Account", provider_id: provider_account.id).to_a
