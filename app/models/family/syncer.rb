class Family::Syncer
  ...
  private
    def child_syncables
      family.plaid_items + family.simplefin_items.active + family.lunchflow_items.active + family.enable_banking_items.active + family.indexa_capital_items + family.accounts.manual + family.sophtron_items.active
    end
end
