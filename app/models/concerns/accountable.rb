module Accountable
  ...
  TYPES = %w[Depository Investment Crypto Property Vehicle OtherAsset CreditCard Loan OtherLiability IndianFixedInvestment IndianGoldInvestment IndianRealEstate IndianBond]
