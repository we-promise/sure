...
class SophtronItem::Syncer
  ...
  def perform_sync(sync)
    SophtronItem::LegacyAccess.with_item(sophtron_item, operation: :sync, sync: sync) do |current, current_sync|
  ...
  private
    ...
    def perform_sync_admitted(sync)
      ...
      sync = Provider::AccountData::LegacyWriterFence.scoped_sync!(sophtron_item, sync)
      ...
      if linked_accounts.any?
        ...
        sophtron_item.process_accounts(sophtron_accounts_scope: linked_accounts, sync: sync)
      ...
      Provider::AccountData::LegacyWriterFence.scoped_sync!(sophtron_item, sync)
