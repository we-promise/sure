...
class SureImport::Preflight
  ...
  def initialize(family:, content:, merge_existing_taxonomy: false)
    @family = family
    @content = content.to_s
    @merge_existing_taxonomy = ActiveModel::Type::Boolean.new.cast(merge_existing_taxonomy)
    @errors = []
    @warnings = []
  ...
  private
    ...
    def validate_taxonomy_collisions
      return if @merge_existing_taxonomy
