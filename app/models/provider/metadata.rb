class Provider
  module Metadata
    REGISTRY = {
      financekit:     { region: "US / UK", kinds: %w[Bank],            maturity: :beta,   logo_text: "AW", logo_color: nil, domain: "apple.com", logo_icon: "wallet", logo_asset: "providers/apple-wallet.png", name: "Apple Wallet" },
