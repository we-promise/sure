class Provider
  module Metadata
    REGISTRY = {
      ...
      simplefin:      { region: "US",      kinds: %w[Bank],            maturity: :stable, logo_text: "SF", logo_bg: "bg-blue-600" },
      lunchflow:      { region: "US",      kinds: %w[Bank],            maturity: :stable, logo_text: "LF", logo_bg: "bg-orange-500" },
      ...
      sophtron:       { region: "US",      kinds: %w[Bank],            maturity: :alpha,  logo_text: "SO", logo_bg: "bg-teal-600" },
      plaid:          { region: "US",      kinds: %w[Bank],            tier: "Paid", maturity: :stable, logo_text: "PL", logo_bg: "bg-indigo-600" },
      plaid_eu:       { name: "Plaid EU", region: "EU", kinds: %w[Bank], tier: "Paid", maturity: :stable, logo_text: "PL", logo_bg: "bg-indigo-600" }
    }.freeze
