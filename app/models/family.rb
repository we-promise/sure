class Family < ApplicationRecord
  include PlaidConnectable, SimplefinConnectable, EnableBankingConnectable, LunchflowConnectable, LunchflowConnectable, Syncable, AutoTransferMatchable, Subscribeable
