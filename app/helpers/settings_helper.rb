module SettingsHelper
  SETTINGS_ORDER = [
    ...
    { name_key: "settings.settings_nav.payment_label", path: :settings_payment_path, condition: :not_self_hosted? },
    ...
    { name_key: "settings.settings_nav.exports_label", path: :family_exports_path, condition: :admin_user? },
    # More section
