module SettingsHelper
  def settings_order = [
    ...
    { name: I18n.t("settings.settings_nav.bank_sync_label"), path: :settings_bank_sync_path },
    ...
    { name: I18n.t("settings.settings_nav.payment_label"), path: :settings_payment_path, condition: :not_self_hosted? },
    ...
    { name: I18n.t("settings.settings_nav.rules_label"), path: :rules_path },
    { name: I18n.t("settings.settings_nav.merchants_label"), path: :family_merchants_path },
    { name: I18n.t("settings.settings_nav.recurring_label"), path: :recurring_transactions_path },
    # Advanced section
    { name: I18n.t("settings.settings_nav.ai_prompts_label"), path: :settings_ai_prompts_path, condition: :admin_user? },
    { name: I18n.t("settings.settings_nav.llm_usage_label"), path: :settings_llm_usage_path, condition: :admin_user? },
    { name: I18n.t("settings.settings_nav.api_key_label"), path: :settings_api_key_path, condition: :admin_user? },
    { name: I18n.t("settings.settings_nav.self_hosting_label"), path: :settings_hosting_path, condition: :self_hosted_and_admin? },
    { name: I18n.t("settings.settings_nav.providers_label"), path: :settings_providers_path, condition: :admin_user? },
    { name: I18n.t("settings.settings_nav.imports_label"), path: :imports_path, condition: :admin_user? },
    { name: I18n.t("settings.settings_nav.exports_label"), path: :family_exports_path, condition: :admin_user? },
    # More section
    { name: I18n.t("settings.settings_nav.guides_label"), path: :settings_guides_path },
